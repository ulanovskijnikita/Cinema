...
class PrefMailAndPass {
    ...
    lateinit var preffNameAndFamily: SharedPreferences
    ...
    fun preffEmailAndPassDeleteAll(pref: SharedPreferences) {
        val editor=pref.edit()
        editor?.clear()
        editor?.apply()
    }

    fun preffEmailAndPassInsert(pref: SharedPreferences) {
        ...
        if (checkBoxState == true) {
            ...
            preffEmailAndPassDeleteAll(pref)
        }
    }
