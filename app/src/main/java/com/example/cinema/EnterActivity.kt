...
class EnterActivity : AppCompatActivity() {
    ...
    private fun name(name: String) {
        prefEmailAndPass.preffEmailAndPass = getSharedPreferences("prefNameAndFamily", MODE_PRIVATE)
        val editor = prefEmailAndPass.preffEmailAndPass.edit()
        editor?.putString("name and family", name)
        editor?.apply()
    }
            ...
            if (prefEmailAndPass.mail.text.toString().isNotEmpty() && prefEmailAndPass.pass.text.toString().isNotEmpty()) {
                when (false) {
                    ...
                    existenceMailAndPass() -> {
                        ...
                        prefEmailAndPass.preffEmailAndPassInsert(prefEmailAndPass.preffEmailAndPass)
